...
import { Gauge, Info, Ruler, Scissors, Sparkles, Timer, Waves, Wand2, Droplets } from 'lucide-react';
 ...
 */
export default function EngineControls({ cfg, uploadId, quality, setQuality, mode, setMode, trim, setTrim, sharpen, setSharpen, plan, plans, loading }) {
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          {['auto', ...profiles.map((p) => p.key)].map((key) => {
